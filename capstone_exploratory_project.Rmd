...
After running into memory issues with many conversion functions, I ended up going from initially trying 50% down to 10% of data samples to do data exploratory.

As I started to work with the Corpus data, I had to start eliminating types of characters until I was able to get a good Corpus fileof alpha words.  I ended up iteratively removing different character types.
...
+ Removed numbers.  They seemed to be extranous information
...
sampleBlog <- sample(blogText,length(blogText)*0.10)
sampleNews <- sample(newsText,length(newsText)*0.10)
sampleTwit <- sample(twitterText,length(twitterText)*0.10)
