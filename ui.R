...
shinyUI(fluidPage(
  ...
  sidebarLayout(position = "right", 
     ...
     sliderInput(inputId = "max_words_returned",
     ...
     tabsetPanel(
       ...
       tabPanel("Instructions",
         br(),
         p("Enter a phrase into the text input field.",style = "font-size:1.1em"),
         br(),
         tags$ul(
            tags$li(
      ...
      tabPanel("About",
        br(),
        p("One of my goals was to do more intergation than trying to re-invent the wheel through
       ...
       p("The app was created in RStudio using an HP EliteBook 8470p
